...
<head>
    ...
    <title>ITM Summary Loading — {{ $data['snapshot']['month_label'] ?? '' }}</title>
...
<header class="ld-header">
    <div class="hd-inner">
        ...
        <div class="hd-brand">
            <a href="{{ route('home') }}"
               style="display:flex;align-items:center;gap:5px;text-decoration:none;
                      ...
                      transition:color .15s" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,.65)'">
            ...
            <div>
                <p class="hd-title"> <img src="" alt="" srcset=""> Summary Loading</p>
                <p class="hd-sub">{{ $data['snapshot']['month_label'] ?? 'Production Dashboard' }}</p>
            </div>
        </div>
        ...
        <nav class="tab-nav">
            ...
            <button class="tab-btn" onclick="window.location.href='{{ route('public.shipment') }}'">
                Summary Shipment
            </button>
        </nav>
        ...
        <div class="hd-controls">
            <!-- Live indicator -->
            <div style="display:flex;align-items:center;gap:5px;font-size:11px;color:rgba(255,255,255,.8);font-weight:600">
                <span class="live-dot"></span> Live
            </div>

            <!-- Date picker -->
            @if(count($availableDates ?? []) > 0)
            <select class="date-select" onchange="window.location.href='/loading?date='+this.value">
