@extends ('layouts.app')
@section('title','Third PartyProduction Report')
@section('page-title', 'Third Party Dashboard')
    ...
    <div class="grid-main">
        ...
        <div class="card" style="animation:fadeUp .5s .1s ease both">
            <div class="card-hd">
                ...
                <span style="font-size:9px;color:#94a3b8;font-weight:500">Click slice for details</span>
            </div>
